 ...
 * @author xatalie
 */
public class JadwalBus extends javax.swing.JFrame {
    public Database database;
    static int id,harga;
    static String nama,alamat,nohp,tipebus,tujuan,tglberangkat;
    BusPariwisata b;
    /**
    ...
    private void initComponents() {
        ...
        btnupdate.setText("Update Jadwal");
        ...
        btncetak.setText("Cetak Jadwal");
        btncetak.setAlignmentX(2.0F);
        btncetak.setAlignmentY(2.0F);
        ...
        btncetak.setBounds(560, 140, 140, 20);
        ...
        tBus.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "ID Pesan", "Pemesan", "Alamat", "Telepon", "Tipe Bus", "Harga", "Tujuan", "Berangkat"
            }
        ));
    ...
    private void cetak(){
        ...
        try{
            sc = System.getProperty("user.dir")+"/src/buspariwisata/bpari.jrxml";
            cr = System.getProperty("user.dir")+"/src/buspariwisata/bpari.jasper";
    ...
    private void btnupdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnupdateMouseClicked
        ...
        try{
            ...
            while(rs.next()){
                Object o[] = {
                    id=Integer.parseInt(rs.getString("id_pesan")),
                    nama=rs.getString("nama"), 
                    alamat=rs.getString("alamat"),
                    nohp=rs.getString("nohp"), 
                    harga=rs.getInt(7),
                    tipebus=rs.getString("tipebus"),
                    tujuan=rs.getString("tujuan"), 
                    tglberangkat=rs.getString("tglberangkat"),
                    
                    
                    
                };
            }
            UbahPesanBus u = new UbahPesanBus();
            u.setVisible(true);
    ...
    private void tabelDaftar(){
        ...
        try{
            ps = database.conn.prepareStatement("select * from pesan");
            ...
            while(rs.next()){
                Object o[] = {
                    ...
                    rs.getString("alamat"),
                    rs.getString("nohp"),
                    rs.getString("tipebus"),
                    rs.getInt("harga"),
                    rs.getString("tujuan"),
                    rs.getString("tglberangkat"),
                };
                model.addRow(o); 
            }     
        }catch (Exception e){
