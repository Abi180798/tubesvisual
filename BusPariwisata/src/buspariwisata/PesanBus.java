...
public class PesanBus extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbtipebus.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbtipebusActionPerformed(evt);
            }
        });
    ...
    private void btntambahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btntambahMouseClicked
        ...
        try {
            ...
            pst.setString(4, tftlp.getText());
            pst.setString(5, jbtipebus.getModel().getSelectedItem().toString());
            pst.setString(6, jbjmlbus.getModel().getSelectedItem().toString());
            pst.setInt(7, Integer.parseInt(tfharga.getText()));
            pst.setString(8, tftujuan.getText());
            pst.setString(9, tftglber.getText());
...
//            tfsisa.setText(sisa.toString());
    ...
    private void jbtipebusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtipebusActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jbtipebusActionPerformed
