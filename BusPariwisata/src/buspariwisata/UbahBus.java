 ...
 * @author xatalie
 */
public class UbahBus extends javax.swing.JFrame {
    ...
    public UbahBus() {
        ...
        tfTipe.setText(u.tipe);
        tfplat.setText(u.plat);
        tfjmlkursi.setText(Integer.toString(u.jml));
        tfharga.setText(Integer.toString(u.harga));
        System.out.println(u.jml);
    }
    ...
    private void initComponents() {
        ...
        btnubah.setText("Update Bus");
        btnubah.setAlignmentX(2.0F);
        btnubah.setAlignmentY(2.0F);
        ...
        jPanel1.add(btnubah);
        btnubah.setBounds(560, 180, 140, 20);
    ...
    private void btnubahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnubahMouseClicked
        // TODO add your handling code here:
        try {
            String sql = "UPDATE bus SET tipe_bus='"+tfTipe.getText()+"',plat='"+tfplat.getText()+"',jumlah_kursi='"+Integer.parseInt(tfjmlkursi.getText())+"',harga='"+Integer.parseInt(tfharga.getText())+"' WHERE id_bus='"+u.id+"'";
